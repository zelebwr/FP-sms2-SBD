            ...
            <div className="flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    <div className="mb-8 text-left">
                        ...
                        <p className="mt-2 text-gray-400">Please enter your personal information</p>
                    </div>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription className="text-xs text-gray-500">
                                            *Password must be more than 8 characters and include uppercase letters, lowercase letters, and numbers
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
