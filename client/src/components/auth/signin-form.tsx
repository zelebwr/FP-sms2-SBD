                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <UnderlinedInput placeholder="Enter your email" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link href="/auth/forgot-password" tabIndex={-1} className="text-xs text-gray-400 hover:text-white">
                                            Forgot?
                                        </Link>
                                    </div>
                                    <FormControl>
...
const UnderlinedInput = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
    ({ className, ...props }, ref) => {
        return (
            <input
